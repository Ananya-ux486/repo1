              ...
              {socialIcons
                ...
                .map(({ icon: Icon, href, label }) => (
                  <a
                    ...
                    title={label}
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-border/80 bg-white text-muted shadow-sm transition hover:-translate-y-0.5 hover:scale-[1.08] hover:border-brand/40 hover:bg-brand hover:text-white hover:shadow-md active:scale-95"
                  >
