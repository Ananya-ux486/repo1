...
export default function TeamBlogSection() {
  ...
  return (
    <section ref={blogReplay.ref} className="relative bg-transparent py-8 lg:py-11">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="mb-6 flex flex-col items-center text-center lg:mb-8">
          ...
          <FloatLine replayKey={blogReplay.replayKey} delay={0.08} className="mt-2">
          ...
          {blogPosts.map((post, i) => (
            ...
            >
              <Link href={`/blog/${post.slug}`} className="block h-full">
                <FloatImageWrap
                  scroll={false}
                  replayKey={blogReplay.replayKey}
