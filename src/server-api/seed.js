...
const fixedPriceSeeds = [
  ["static-websites", "₹15k", "$249"],
  ["landing-pages", "₹10k", "$199"],
  ["dynamic-websites", "₹30k", "$349"],
  ["e-commerce-solutions", "₹40k", "$449"],
];
...
export async function seedCmsContent() {
  ...
  await Promise.all(
    fixedPriceSeeds.map(([slug, indiaPrice, foreignPrice]) =>
      Service.updateOne(
        {
          slug,
          $or: [
